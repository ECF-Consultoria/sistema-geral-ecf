...
/**
 * Fase 150 (plano 02, ETAPA-01) — coluna `companies.etapa`: a etapa do fluxo
 ...
 * etapa 1, o que é falso e inundaria a listagem da Fase 151. O backfill
 * real (dois baldes, D-04/D-05) é o comando Artisan do plano 150-05 — não
 * esta migration.
 *
 ...
 * migrations dos planos 150-03 (`120000`) e 150-04 (`130000`), que rodam em
...
return new class extends Migration
{
    public function up(): void
    {
        Schema::table('companies', function (Blueprint $table) {
            ...
            $table->index('etapa'); // WHERE etapa = ? no filtro do plano 150-07
        });
    }
