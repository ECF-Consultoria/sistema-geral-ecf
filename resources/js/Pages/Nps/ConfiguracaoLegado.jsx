 ...
 * Phase 70 — Plan 05 (v15.0) — Renomeada para `ConfiguracaoLegado.jsx`.
 *   A rota `/nps/configuracao/textos-legado` continua servindo esta UI enquanto
 *   a nova `/nps/configuracao` passa a renderizar `Configuracao.jsx` (v15.0
 *   multi-template). Comportamento inalterado — apenas o alias de página muda.
 *
