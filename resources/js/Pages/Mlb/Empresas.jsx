...
const DEFAULT_STATUS   = ['M0','M1','M2','M3','M4','Fechamento','Encerrado','Protocolo Churn','Desistência','Churn'];
                ...
                <form onSubmit={submit} className="space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        ...
                        <div>
                            <label className="text-white/50 text-[11px] uppercase tracking-wide font-semibold block mb-1">
                                Status
                                <span className="text-white/25 ml-1 normal-case font-normal">— M0..M4, Fechamento, Encerrado, Protocolo Churn, Desistência, Churn</span>
                            </label>
                            <ComboInput
                                value={data.fase}
