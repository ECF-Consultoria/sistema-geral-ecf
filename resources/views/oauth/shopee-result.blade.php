...
<head>
    ...
    <title>Conexão Shopee — ECF Consultoria</title>
    <style>
...
<body>
    <div class="card">
        @if($success)
            ...
            <p>A loja <strong class="brand">Shopee</strong> foi vinculada com sucesso ao sistema <strong>ECF Consultoria</strong>.</p>
        @else
            <div class="icon">❌</div>
