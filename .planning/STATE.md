...
Last activity: 2026-06-24 — Fast fix: GET /dashboard estourava max_execution_time (30s) porque em QUEUE_CONNECTION=sync o RefreshGrossBillingCacheJob::dispatch() rodava inline (usleep ~7s/empresa) com cache frio; nova helper dispatchIfQueued() pula o warm-up em sync (4 call-sites); produção inalterada; commit 84c1c4f
