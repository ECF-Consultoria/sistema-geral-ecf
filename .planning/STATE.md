...
| 260618-l4u | Precificação do link do cliente (Mlb/ImplementacaoPublica.jsx, SimuladorPreco): alerta âmbar "Frete não inserido" quando o frete do produto/tier selecionado está vazio/zerado (freteN <= 0), some ao informar frete > 0. Link "Tabela de Frete" (ecf-yellow, ExternalLink, nova aba) ao lado do rótulo "Frete (Clássico/Premium)" — reusa a URL global tabela_frete_url (mesma do ChecklistItem), propagada via prop tabelaFreteUrl por toda a cadeia (ImplementacaoPublica → PrecificacaoModal → SimuladorPreco); não renderiza quando a URL não está configurada. | 2026-06-18 | 60d0356 | [260618-l4u-alerta-frete-nao-inserido-e-link-tabela-](.planning/quick/260618-l4u-alerta-frete-nao-inserido-e-link-tabela-/) |
