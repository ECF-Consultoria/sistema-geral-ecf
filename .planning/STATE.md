...
Last activity: 2026-06-24 — Quick 260624-igv: reorganiza nav (Projetos: Polos→Comercial) + nova página "Empresas por M" no grupo Polos (rota mlb.polos-empresas + MlbController::polosEmpresas()) com empresas POLOS por fase M0–M4 em grid de cards (estilo EmpresaCardGrid); Projetos.jsx intacto; build verde; sem deploy; commits 5b1f8c0, 7d84ebd, 8b82478
