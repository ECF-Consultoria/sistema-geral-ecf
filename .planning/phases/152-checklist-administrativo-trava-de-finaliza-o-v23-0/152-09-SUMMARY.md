...
key-decisions:
  ...
  - "O docblock de Comercial/Entrada.jsx foi corrigido: dizia que o checklist tem 8 itens e chegaria na Fase 152, e que nenhum controle da tela fingia que os itens existiam. As três afirmações ficaram falsas com esta fase"

patterns-established:
  - "Docblock que enuncia uma proibição não pode citar o identificador proibido em prosa: o grep de auditoria do próprio plano não distingue comentário de código. Terceira ocorrência nesta fase (152-02, 152-03, 152-04) — descrever a proibição em palavras, sem o literal"
...
# Phase 152 Plan 09: a fase vira tela Summary
...
- **Docblock corrigido.** O texto anterior dizia que "o checklist dos 8 itens do módulo ... chega na
  Fase 152. Nenhum controle desta tela finge que esses itens já existem" — as três afirmações
...
Backend sem regressão: `tests/Unit/Phase152 + tests/Feature/Phase152` continua **92 testes / 364
...
**É a terceira vez nesta fase** (152-02, 152-03, 152-04 tiveram exatamente o mesmo desvio, cada uma
...
- A fase está **funcionalmente completa**: serviços (152-02..07), camada HTTP (152-08) e tela
  (152-09). Resta o plano **152-10**, que é o fechamento — a conferência visual das telas em
  ...
  código-fonte).
- **Itens para a conferência visual do 152-10, em ordem de risco:**
