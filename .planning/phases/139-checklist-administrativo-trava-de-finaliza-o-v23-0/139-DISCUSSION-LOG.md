# Phase 139: Checklist administrativo + trava de finalização (v23.0) - Discussion Log
...
| No banco, editável por tela | Custa tabela + tela + permissão, e a Fase 140 já fará edição sem deploy. | |
...
| Opção | Descrição | Selecionada |
|--------|-------------|----------|
| A permissão do módulo já basta | `comercial.entrada` e `admin.contratos`, ambas da Fase 138. | ✓ |
