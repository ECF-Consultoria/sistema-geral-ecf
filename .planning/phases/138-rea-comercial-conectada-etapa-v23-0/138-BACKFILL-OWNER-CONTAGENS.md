# 138-04 — Contagens do retroativo `hubspot:backfill-owner-venda`
...
disciplina de escrita em massa numa tabela com ~500 registros reais (T-138-12 do threat
...
2. `HUBSPOT_ACCESS_TOKEN` de produção configurado e a medição da property real de owner
   (pendência já registrada em `138-HUBSPOT-MEDICOES.md`, responsabilidade do plano 138-09).
