# Phase 138: Área Comercial conectada à etapa (v23.0) - Discussion Log

> **Audit trail only.** Do not use as input to planning, research, or execution agents.
> Decisões estão no `138-CONTEXT.md` — este log preserva as alternativas consideradas.
...
SQLite dos testes não pega; a Fase 143 vai querer a data da venda como evento datado.
...
`.planning/seeds/138-140-admin-no-comercial-dois-modulos-260902.md`, e o documento chegou na
...
| Opção | Descrição | Selected |
|---|---|---|
| 138 entrega a casca; checklists na 139 | Reorganização + Empresas Ganhas + nascimento na etapa 1; tarefas ficam na Fase 139 | ✓ |
...
### O que popula cada lista na Fase 138
...
| Só a pendência do fluxo (Fase 137) | Mais limpo, mas as 8 comerciais somem das listas novas | |
| Só as 8 comerciais derivadas | Rejeitada — é o modo de falha que a D-17 da Fase 137 documenta | |
...
| Opção | Descrição | Selected |
|---|---|---|
| Não carimbar o legado | Segue a D-05 da Fase 137 — nunca deduzir etapa de estado externo | ✓ |
...
- Destino da Fase 140 (mensagem de boas-vindas virou item do módulo Entrada).
- Resolver o conflito de contagem §3 (12 atividades) × §5 (9 controles) — decisão da Fase 139.
