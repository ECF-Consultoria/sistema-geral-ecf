...
- [ ] **Phase 55: Modernização visual /sugadores + Magic UI** — briefing 2026-07-02 (2 itens). (C1) redesign tabela sugadores estilo shadcn/ui do print: header cinza, checkbox quadrado, drag handles, row hover, tabs superiores, colunas customizáveis, botões "Customize Columns" / "+ Add Section"; (C2) adotar componentes selecionados da [Magic UI](https://magicui.design). Manter tokens `ecf-*` + dark theme. Depends Phase 54.
