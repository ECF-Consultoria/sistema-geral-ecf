...
- [ ] 41-03-PLAN.md — Refactor comando `sugadores:shadow-ml --company=all` priorizando `SugadorMlCompanyConfig::where('shadow_enabled', true)` + fallback env CSV preservado + tests config table vs env (REQ-41-07)
