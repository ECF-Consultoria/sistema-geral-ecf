...
**Success Criteria** (o que deve ser VERDADE):
  ...
  6. Os 5 passos de `dono=sistema` do template de Gestão se resolvem sem digitação humana, por resolvers registrados em código: `adman_account_id`, grant Adman (sonda por `cust_id` — ver D-18), `ml_tokens.status`, `ml_acervo_itens`, `MercadoLivreService::fetchUserInfo()`
