...
class Modules
{
    ...
    public const CHAMADOS                    = 'chamados';
    ...
    public static function catalog(): array
    {
        return [
            ...
            'Dev' => [
                ...
                ['key' => self::CHAMADOS,            'name' => 'Tickets',                  'grupo' => 'Dev', 'route_prefix' => 'chamados.',          'permission_key' => null,                                  'stage' => 'homologacao', 'nasce_oculto' => true],
                ['key' => self::DEV_DEMANDAS,        'name' => 'Demandas Dev',             'grupo' => 'Dev', 'route_prefix' => 'dev.demandas.',      'permission_key' => null,                                  'stage' => 'homologacao', 'nasce_oculto' => true],
