...
class ChecklistAcessoPorEntradaTest extends TestCase
{
    ...
    /**
     * T-139-08-01 — a rota em OR alarga quem alcança esta ficha; o payload é
     * o que impede a escalada virar vazamento. Até a Fase 138, só quem tinha
    ...
    private function empresaComContrato(array $attrs = []): Company
    {
        ...
        $servico = Servico::create([
            'nome'           => 'Performance (checklist 139-08)',
            'valor_padrao'   => 100,
