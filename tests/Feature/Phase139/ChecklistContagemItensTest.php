...
/**
 * Fase 139 Plano 05 (ADMIN-01, D-07) — ChecklistAdministrativoService::paraEmpresa().
 *
...
class ChecklistContagemItensTest extends TestCase
{
    ...
    private function servicoComContrato(string $nome = 'Gestão de Tráfego (checklist 139-05)'): Servico
    {
    ...
    private function servicoIsento(string $nome = 'Polos (checklist 139-05)'): Servico
    {
        return Servico::create([
            'nome'           => $nome,
            'valor_padrao'   => 100,
