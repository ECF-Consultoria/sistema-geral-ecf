...
/**
 * Fase 139 Plano 06 (ADMIN-06, D-12) —
...
class FinalizarTransicaoEtapaTest extends TestCase
{
    ...
    private function servicoComContrato(): Servico
    {
        return Servico::create([
            'nome'           => 'Gestão de Tráfego (transição 139-06)',
            'valor_padrao'   => 100,
    ...
    private function completarGrupoEntrada(Company $empresa, User $usuario, array $manuaisAIgnorar = []): void
    {
        ...
        OnboardingLink::create(['company_id' => $empresa->id, 'token' => 'token-transicao-139-06-' . $empresa->id]);
    }
     ...
     * antes de chamar `finalizar()` (caso do plano 139-08). Os dois casos
