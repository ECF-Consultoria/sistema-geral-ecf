...
class NpsFloorDesempenhoTest extends TestCase
{
    ...
    // ═══════════════════════════════════════════════════════════════════
    // 7 — cacheKey() já reflete o bump (hoje v16, Fase 122 · SNAP-05)
    // ═══════════════════════════════════════════════════════════════════

    #[Test]
    public function test_cache_key_esta_na_v16(): void
    {
        $service = app(DesempenhoScoreService::class);
        ...
        $this->assertStringStartsWith('desempenho.compute.v18.', $chave,
