...
/**
 * Fase 152 Plano 08 (ADMIN-04/ADMIN-05/ADMIN-06, D-09/D-15) — os 4 endpoints do
...
class ChecklistEndpointsTest extends TestCase
{
    ...
    private function servicoComContrato(): Servico
    {
        return Servico::create([
            'nome'           => 'Performance (endpoints 152-08)',
            'valor_padrao'   => 100,
    ...
    // ─── Caso 2 — user_id no corpo é IGNORADO (ADMIN-04, T-150-02) ──────────
    ...
    // ─── Caso 11 — a mutação atinge só a empresa da rota (T-152-08-03) ──────
