...
/**
 * Fase 152 Plano 06 (ADMIN-05, D-07) —
 ...
 *
 * Setup copiado de `ChecklistMarcacaoManualAutoriaTest.php` (Fase 152 Plano
...
class FinalizarTravaTest extends TestCase
{
    ...
    private function servicoComContrato(): Servico
    {
        return Servico::create([
            'nome'           => 'Gestão de Tráfego (trava 152-06)',
            'valor_padrao'   => 100,
