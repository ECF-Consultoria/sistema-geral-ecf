...
/**
 * Fase 150 (plano 05, ETAPA-02) — prova dos dois baldes do `etapa:backfill`
...
class EtapaBackfillTest extends TestCase
{
    ...
    // ═══════════════════════════════════════════════════════════════════
    // Plano 150-10 (G5/WR-02) — nome duplicado não descarta empresa do balde 1
    // ═══════════════════════════════════════════════════════════════════
    ...
    // ═══════════════════════════════════════════════════════════════════
    // carimbarBackfill() não gera histórico (T-150-15, aceito por decisão)
    // ═══════════════════════════════════════════════════════════════════
    ...
    public function test_apply_nao_gera_linha_de_historico(): void
    {
        ...
        $this->assertSame(
            ...
            'carimbarBackfill() é deliberadamente sem histórico — não deve inventar duração fictícia no SLA da Fase 156'
        );
    }
