...
/**
 * Fase 150 (plano 09, gap closure G2 / CR-02 do `150-REVIEW.md`) — prova
 ...
 * o propósito do dado, que a Fase 156 consome para medir SLA. O `CASCADE`
...
class EtapaHistoricoAtorTest extends TestCase
{
    ...
    //    ele movimentou — só a referência ao ator vira NULL (T-150-26)
    // ═════════════════════════════════════════════════════════════════════
    ...
    public function test_force_delete_do_ator_preserva_historico_da_empresa_e_zera_so_o_autor(): void
    {
        ...
        $this->assertNotNull(
            ...
            'o histórico de transição da empresa X foi apagado ao remover permanentemente o usuário ator — CR-02 / Fase 156 perde o insumo de SLA'
        );
        $this->assertNull(
            $linha->user_id,
