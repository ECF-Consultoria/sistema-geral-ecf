...
/**
 * Fase 150 (plano 03) — prova da régua pura `podeTransicionar()` (ETAPA-06,
...
class EtapaTransicaoServiceTest extends TestCase
{
    ...
    // ─── Plano 150-10 (G4/WR-01): transicionar() decide sobre a LINHA
     ...
     * estático de 150-08 exatamente para permitir isto (ver
     * `150-10-PLAN.md`, Task 1, item 6).
     */
