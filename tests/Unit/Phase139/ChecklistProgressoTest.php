...
/**
 * Fase 139 Plano 05 (D-10) — ChecklistAdministrativoService::progresso().
 *
...
class ChecklistProgressoTest extends TestCase
{
    ...
    {
        return Servico::create([
            'nome'           => 'Gestão de Tráfego (progresso 139-05)',
            'valor_padrao'   => 100,
            'tipo_cobranca'  => Servico::TIPO_MENSAL,
            'ativo'          => true,
    ...
    private function fecharAutomaticosDeEntrada(Company $company): void
    {
        ...
        OnboardingLink::create(['company_id' => $company->id, 'token' => 'token-progresso-139-05']);
    }
